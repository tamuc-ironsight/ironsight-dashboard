export const getVMList = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_vms`
  );
...
export const getLabList = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_labs`
  );
...
export const getTemplateList = async () => {
  const response = await fetch( 
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_templates`
  );
  if (!response.ok) {
...
export const getNewsList = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_news`
  );
...
export const getDocCount = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=%27{%22size%22:100,%22aggs%22:{%22hostnames%22:{%22terms%22:{%22field%22:%22host.name%22,%22size%22:100}}}}%27`
  );
...
export const getCPUUsage = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_cpu_usage&step=5`
  );
  if (!response.ok) {
...
export const getNetworkUsage = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_network_usage&step=5`
  );
  if (!response.ok) {
...
export const getMemoryUsage = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_memory_usage&step=5`
  );
  if (!response.ok) {
...
export const getMetrics = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_metrics`
  );
  if (!response.ok) {
...
export const getDiskUsage = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_disk_usage&step=5`
  );
  if (!response.ok) {
...
export const getVMCPUUsage = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_vm_cpu_usage&step=5`
  );
  if (!response.ok) {
...
export const getVMMemoryUsage = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_vm_memory_usage&step=5`
  );
  if (!response.ok) {
...
export const getVMNetworkPacketsReceived = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_vm_network_packets_received&step=5`
  );
  if (!response.ok) {
...
export const getVMNetworkPacketsSent = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_vm_network_packets_sent&step=5`
  );
  if (!response.ok) {
...
export const getNumVMsOn = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_num_vms_on`
  );
  if (!response.ok) {
...
export const getNumVMs = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_num_vms`
  );
  if (!response.ok) {
...
export const getVMsOn = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_vms_on`
  );
  if (!response.ok) {
...
export const getLabOverview = async ({ queryKey }) => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_lab_overview&lab_num=${queryKey[1]}`
  );
  if (!response.ok) {
...
export const getCourseList = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_courses`
  );
  if (!response.ok) {
...
export const getTags = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_tags`
  );
  if (!response.ok) {
...
export const getUsersList = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_users`
  );
  if (!response.ok) {
...
export const getRoles = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_roles`
  );
  if (!response.ok) {
...
export const getPermissions = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_permissions`
  );
  if (!response.ok) {
...
export const getHarvesterVMList = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=get_harvester_vms`
  );
  if (!response.ok) {
...
export const getActivityLog = async () => {
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}log_data.php`
  );
  if (!response.ok) {
...
export const handleEvent = async (event_data) => {
  ...
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}event_handler.php`,
    {
      method: "POST",
      headers: {
...
export const postActivityLog = (username, activity) => {
  return fetch(`${process.env.REACT_APP_IRONSIGHT_API_URL}log_data.php`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export const powerOnVM = async ({ queryKey }) => {
  ...
  const response = await fetch(
    `${process.env.REACT_APP_IRONSIGHT_API_URL}get.php?q=power_on_vm&vm_name=${queryKey[1]}`
  );
  if (!response.ok) {
...
export const authenticate = (username, password) => {
  ...
  try {
    return fetch(`${process.env.REACT_APP_IRONSIGHT_API_URL}authenticate.php`, {
      method: "POST",
      headers: {},
